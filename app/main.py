...
class CompletedJob(BaseModel):
    """The class specification for a completed job (weather data for a single observation/job)

    Attributes:
        id (int): The observation id
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://spatiotemporal-wildlife-classification.github.io"],  # Adjust this based on your requirements
